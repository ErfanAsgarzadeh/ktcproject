          ...
          {activeTab === 'projects' && (
              <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 pb-10">
                ...
                <div className="lg:col-span-7 space-y-6">
                  ...
                  Revision Identifier: <code className="text-slate-400 font-bold">{String(rev.id).split('-').pop()?.substring(0, 8) || String(rev.id)}</code>                            </span>
                ...
                <div className="lg:col-span-8 space-y-6">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4 max-h-[500px] overflow-y-auto pr-1">
                    {users.map(user => (
                        ...
                        >
                          <div className="flex items-center gap-3">
                            <div className="w-10 h-10 rounded-lg bg-indigo-500/10 border border-indigo-500/20 text-indigo-300 font-bold text-sm flex items-center justify-center tracking-wide uppercase shrink-0">
                ...
                <div className="lg:col-span-4 space-y-6">
                  <div className="bg-white/5 p-6 rounded-xl border border-white/10 space-y-5 backdrop-blur-sm">
                    ...
                    <form onSubmit={handleCreateUser} className="space-y-3 font-sans">
                      <div className="space-y-1">
                        <label className="block text-[10px] text-slate-400 font-semibold">User Real Name</label>
                        <input
                            type="text"
                            required
                      ...
                      <div className="space-y-1">
                        <label className="block text-[10px] text-slate-400 font-semibold">Assigned Job Designation</label>
                        <input
                            type="text"
                      ...
                      <div className="space-y-1">
                        <label className="block text-[10px] text-slate-400 font-semibold">Employee ID Badge</label>
                        <input
                            type="text"
                      ...
                      <button
                          type="submit"
                          className="w-full py-2 bg-gradient-to-r from-cyan-500 to-indigo-600 hover:from-cyan-600 hover:to-indigo-700 text-white font-semibold text-xs rounded-lg shadow-lg shadow-indigo-500/10 transition-all flex items-center justify-center gap-1 cursor-pointer pt-2"
                      >
